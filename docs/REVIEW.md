...
The comment stays pinned to that spot on that page, so we know exactly what
you meant without you having to describe where it is. You can reply to each
other's notes, and drag a screenshot in if that's easier than typing.

Works the same on a phone. The toolbar only appears for the two of you and
Trav — visitors will never see it.

**Anything you'd rather send by email, just email.** The comments are a
